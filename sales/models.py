...
from hrm_system.models import Client, Employee

from sales.port_id.models import (UniqueUserId)
...
class Product(models.Model):
    port = models.ForeignKey(UniqueUserId, on_delete=models.CASCADE,
                             null=True, blank=True, help_text='user portfolio id')
...
class Invoice (models.Model):
    ...
    TERMS = [('7 days', '7 days'), ('14 days', '14 days'), ('30 days', '30 days'),
             ('45 days', '45 days'), ('60 days', '60 days'), ('90 days', '90 days')]
...
class Setting(models.Model):
    ...
    user = models.ForeignKey(settings.AUTH_USER_MODEL,
                             on_delete=models.CASCADE, null=True, blank=True)
    PROVINCES = [('Proviance1', 'Proviance1'), ('Proviance2',
                                                'Proviance2'), ('Proviance3', 'Proviance3')]
